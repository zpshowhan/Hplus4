$(function(){
	...
	a={
		...
		calculable:!0,xAxis:[{type:"category",boundaryGap:!1,
	...
	var t=echarts.init(document.getElementById("echarts-bar-chart")),
		n={title:{text:"某地区蒸发量和降水量"},
		tooltip:{trigger:"axis"},
		legend:{data:["蒸发量","降水量"]},grid:{x:30,x2:40,y2:24},calculable:!0,
